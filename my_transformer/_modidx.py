...
d = { 'settings': { 'doc_baseurl': '/transformer_implementations',
  ...
  'syms': { 'my_transformer.components': { 'my_transformer.components.DecoderLayer': ( 'components.html#decoderlayer',
                                           ...
                                           'my_transformer.components.unidirectional_mask': ( 'components.html#unidirectional_mask',
                                                                                              'my_transformer/components.py')},
            'my_transformer.position_encoding': { 'my_transformer.position_encoding.PositionalEncoder': ( 'pos_encoding.html#positionalencoder',
                                                                                                          'my_transformer/position_encoding.py'),
                                                  'my_transformer.position_encoding.PositionalEncoder.__init__': ( 'pos_encoding.html#positionalencoder.__init__',
                                                                                                                   'my_transformer/position_encoding.py'),
                                                  'my_transformer.position_encoding.PositionalEncoder.forward': ( 'pos_encoding.html#positionalencoder.forward',
                                                                                                                  'my_transformer/position_encoding.py'),
                                                  'my_transformer.position_encoding.PositionalEncoder.positional_encoding': ( 'pos_encoding.html#positionalencoder.positional_encoding',
                                                                                                                              'my_transformer/position_encoding.py')},
