...
# %% auto 0
__all__ = ['sents', 'trf_pre_tokenizer', 'my_pre_tokenizer', 'trf_decoder', 'my_decoder', 'tk', 'ptk', 'text', 'text_enc',
           'ByteLevelPreTokenizer', 'ByteLevelDecoder', 'BPETokenizer']
...
ByteLevelPreTokenizer(add_prefix_space=False).pre_tokenize_str(
