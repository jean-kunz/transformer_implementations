...
# %% auto 0
__all__ = ['device', 'g', 'do_train', 'model_version', 'model_name', 'last_iter', 'max_iter', 'unidirectional_mask', 'attention',
           'MultiHeadAttention', 'LayerNormalization', 'DecoderLayer', 'DecoderTransformer', 'Trainer']
